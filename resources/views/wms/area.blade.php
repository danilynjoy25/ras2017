...
<script type="text/javascript">
    ...
    chart = new Highcharts.StockChart(config, function () {
    ...
    $.datepicker.setDefaults({
      ...
      onSelect: function (dateText) {
        ...
        //this.onchange();
        this.onblur();
        console.log($('input.highcharts-range-selector:eq(0)').datepicker("getDate").getTime());
      }
    });
    console.log(sound_level_data[0][0]);
  });
