      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown ">
            <a class="nav-link dropdown-toggle" id="projectsDropdown" href="#" data-toggle="dropdown" aria-haspopup="true"
              aria-expanded="false">
              Projects
            </a>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="modal" data-target="#exampleModal">
              <i class="fa fa-fw fa-sign-out nav-item" href="{{ route('logout') }}" onclick="event.preventDefault();
